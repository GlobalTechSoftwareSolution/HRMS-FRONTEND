...
const downloadPDF = async (record: PayrollRecord) => {
  ...
  // Draw table headers
  page.drawText("Earnings", { x: tableX, y, size: 14, font: boldFont, color: rgb(0, 0.53, 0.71) });
  page.drawText("Deductions", { x: tableX + tableWidth / 2, y, size: 14, font: boldFont, color: rgb(0, 0.53, 0.71) });
  y -= 20;
        ...
        {loading ? (
          ...
          <div className="space-y-6">
            {payrollData.map((record) => {
              ...
              const totalEarnings = record.basic_salary + allowances + bonus;
              const totalDeductions = record.tax + deductions;
