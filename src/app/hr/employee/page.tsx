          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white p-6 rounded-lg w-full max-w-3xl max-h-[80vh] overflow-y-auto">
              ...
              <div className="flex items-center mb-6">
                <div className="h-16 w-16 rounded-full bg-blue-100 overflow-hidden flex items-center justify-center text-blue-600 font-bold text-xl">
                ...
                <div className="ml-4">
                  <h4 className="text-lg font-medium">{selectedEmployee.fullname}</h4>
              ...
              <div className="mb-6">
                ...
                {awardData[selectedEmployee.email]?.length ? (
                    ...
                    {awardData[selectedEmployee.email].map((award) => (
                      <li key={award.id} className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">{award.description || "No description"}</p>
                  ...
                  <p className="text-gray-500 text-sm">No awards found.</p>
                )}
              </div>
