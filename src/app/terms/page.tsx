        ...
        <div className="p-8">
          ...
          <div className="mb-10 text-center">
            <p className="text-gray-600 mb-6">
              Welcome to our HR Management System. Please read these terms and
              our privacy policy carefully before using our platform.
            </p>
              ...
              <div className="mt-4 pl-2 border-l-4 border-blue-200 ml-3">
                ...
                <div className="mb-6">
                  ...
                  <p className="text-gray-600 ml-7">
                    By accessing or using the HRMS platform, you acknowledge
                ...
                <div className="mb-6">
                  ...
                  <p className="text-gray-600 ml-7">
                    ...
                    under your account. Immediately notify us of any
                ...
                <div className="mb-6">
                  ...
                  <p className="text-gray-600 ml-7">
                    The HRMS platform is intended for legitimate human resources
                    management purposes only. You agree not to misuse the
                ...
                <div className="mb-6">
                  ...
                  <p className="text-gray-600 ml-7">
                    All content, features, and functionality of the HRMS
                    platform, including but not limited to text, graphics,
                    logos, and software, are the exclusive property of the
                    company and are protected by international copyright,
                ...
                <div className="mb-6">
                  ...
                  <p className="text-gray-600 ml-7">
                    ...
                    limited to loss of profits, data, or use, whether in an
                    action in contract, tort, or otherwise, arising out of or in
                    any way connected with the use of our platform.
                  </p>
                </div>
                ...
                <div className="mb-6">
                  ...
                  <p className="text-gray-600 ml-7">
                    ...
                    platform or via email. Continued use of the platform after
              ...
              <div className="mt-4 pl-2 border-l-4 border-indigo-200 ml-3">
                ...
                <div className="mb-6">
                  ...
                  <p className="text-gray-600 ml-7">
                    ...
                    including personal and HR-related employee data. This may
                    include:
                  </p>
                  <ul className="text-gray-600 ml-12 list-disc mt-2">
